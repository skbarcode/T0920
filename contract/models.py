...
class company(models.Model):
    ...
    title_en = models.CharField(verbose_name='公司名称英文', max_length=64,blank=True,null=True,)
    ...
    email = models.EmailField(verbose_name='邮件', max_length=24,blank=True,null=True,)
    url = models.URLField(verbose_name='网址', max_length=24,blank=True,null=True,)
    bank = models.CharField(verbose_name='对公银行', max_length=24,blank=True,null=True,)
    bank_no = models.CharField(verbose_name='银行帐号', max_length=24,blank=True,null=True,)
...
class contact_information(models.Model):  # 联系信息
    ...
    address = models.CharField(verbose_name='联系地址', max_length=64,blank=True,null=True,)
    phone = models.CharField(verbose_name='联系手机', max_length=12,)
    tel = models.CharField(verbose_name='联系电话', max_length=12,blank=True,null=True,)
    fax = models.CharField(verbose_name='联系传真', max_length=12,blank=True,null=True,)
...
class client(models.Model):  # 客户信息
    title = models.CharField(max_length=24, verbose_name='公司名称',unique=True)
    address = models.CharField(verbose_name='地址', max_length=32)
    telphone = models.CharField(verbose_name='电话', max_length=12)
    fax = models.CharField(verbose_name='传真', max_length=12,blank=True,null=True,)
    bank = models.CharField(verbose_name='对公银行', max_length=24,blank=True,null=True,)
    bank_no = models.CharField(verbose_name='银行帐号', max_length=24,blank=True,null=True,)
...
class product_info(models.Model):
    ...
    meno = models.CharField(max_length=64, verbose_name='备注',blank=True,null=True,)
...
class contract_info(models.Model):
    ...
    delivery_dates = models.CharField(choices=delivery_date, verbose_name='交货时间',  max_length=24)
    freight = models.CharField(choices=freight_choices, verbose_name='运费', max_length=24)
    delivery_Method = models.CharField(choices=delivery_Method_choices, verbose_name='交货方式',  max_length=24)
    invoice_info = models.CharField(choices=invoice_info_choices, verbose_name='发票税率',  max_length=24)
    ...
    add_info = models.CharField(max_length=256, verbose_name='补充协议',
                                default='打印头质保三个月或三十公里，先到为准，人为或物理损坏不在质保范围（包含但不限于打印头表面有白点、磨伤、损坏、变形、烧头等）',blank=True,null=True,)
    start_date = models.DateField(verbose_name='开始日期')
    end_date = models.DateField(verbose_name='结束日期')
    create_time = models.DateTimeField(auto_now_add=True,verbose_name='创建合同时间',)
    update_time = models.DateTimeField(auto_now=True,verbose_name='更新合同时间')
